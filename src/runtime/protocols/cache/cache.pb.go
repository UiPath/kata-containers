...
type GrpcVM struct {
	...
	VmStorePath          string   `protobuf:"bytes,8,opt,name=vmStorePath,proto3" json:"vmStorePath,omitempty"`
	SharedPath           string   `protobuf:"bytes,9,opt,name=sharedPath,proto3" json:"sharedPath,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GrpcVM) GetVmStorePath() string {
	if m != nil {
		return m.VmStorePath
	}
	return ""
}

func (m *GrpcVM) GetSharedPath() string {
	if m != nil {
		return m.SharedPath
	}
	return ""
...
var fileDescriptor_5fca3b110c9bbf3a = []byte{
	...
	,
}
...
func (m *GrpcVM) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SharedPath) > 0 {
		i -= len(m.SharedPath)
		copy(dAtA[i:], m.SharedPath)
		i = encodeVarintCache(dAtA, i, uint64(len(m.SharedPath)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.VmStorePath) > 0 {
		i -= len(m.VmStorePath)
		copy(dAtA[i:], m.VmStorePath)
		i = encodeVarintCache(dAtA, i, uint64(len(m.VmStorePath)))
		i--
		dAtA[i] = 0x42
	}
	if m.CpuDelta != 0 {
...
func (m *GrpcVM) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VmStorePath", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VmStorePath = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SharedPath", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SharedPath = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCache(dAtA[iNdEx:])
